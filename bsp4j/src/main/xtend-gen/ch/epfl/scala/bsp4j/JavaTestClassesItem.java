...
public class JavaTestClassesItem {
  @NonNull
  ...
  public JavaTestClassesItem(@NonNull final BuildTargetIdentifier target, @NonNull final List<String> classes) {
    this.target = target;
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    JavaTestClassesItem other = (JavaTestClassesItem) obj;
    if (this.target == null) {
