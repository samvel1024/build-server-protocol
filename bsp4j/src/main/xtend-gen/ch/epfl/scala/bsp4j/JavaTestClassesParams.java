...
public class JavaTestClassesParams {
  @NonNull
  private List<BuildTargetIdentifier> targets;
  
  private String originId;
  
  public JavaTestClassesParams(@NonNull final List<BuildTargetIdentifier> targets) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    JavaTestClassesParams other = (JavaTestClassesParams) obj;
