...
public class JavaClasspathParams {
  @NonNull
  private List<BuildTargetIdentifier> targets;
  
  public JavaClasspathParams(@NonNull final List<BuildTargetIdentifier> targets) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    JavaClasspathParams other = (JavaClasspathParams) obj;
