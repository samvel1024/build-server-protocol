...
public class JavaMainClassesParams {
  @NonNull
  private List<BuildTargetIdentifier> targets;
  
  private String originId;
  
  public JavaMainClassesParams(@NonNull final List<BuildTargetIdentifier> targets) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    JavaMainClassesParams other = (JavaMainClassesParams) obj;
